...
export default function Dashboard() {
  return (
    <div>
      <PageHead
        title="Deal Brain"
        sub="Think → Remember → Create. Everything captured across your deals this week, auto-summarized and distilled into structured knowledge."
      ...
      <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <Stat label="Sources connected" value="3" hint="Email · Data room · DMS" />
