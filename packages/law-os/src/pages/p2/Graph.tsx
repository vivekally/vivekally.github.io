  ...
  return (
    <div>
      <PageHead
        ...
        sub="Typed edges connect people, issues, artifacts and decisions. The graph wires itself as the record lands."
      ...
      <div className="mt-4 flex flex-wrap gap-4 text-xs text-slate-400">
        ...
        <span className="ml-auto text-slate-500">
          Edge types: admitted · caused · supports · risk_to · produced · informs
        </span>
      </div>
    </div>
  );
