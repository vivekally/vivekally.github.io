...
const phases = [
  { id: "phase-1", label: "Phase 1", name: "Lawyer Onboarding", tier: "Free", tierTone: "green" as const },
  { id: "phase-2", label: "Phase 2", name: "Matter Brain", tier: "Add-on", tierTone: "amber" as const },
  { id: "phase-3", label: "Phase 3", name: "Scale to the Firm", tier: "Teams", tierTone: "slate" as const },
];
...
const nav: Record<string, { to: string; label: string; icon: string }[]> = {
  "phase-1": [
    ...
    { to: "/phase-1/health", label: "Matter Health", icon: "♥" },
    { to: "/phase-1/branding", label: "Practice Development", icon: "✦" },
  ],
  "phase-2": [
  ...
  "phase-3": [
    { to: "/phase-3/org", label: "Practice Group", icon: "▦" },
    { to: "/phase-3/company-brain", label: "Firm Brain", icon: "◫" },
      ...
      <aside className="fixed inset-y-0 left-0 z-20 flex w-60 flex-col border-r border-line bg-[#0A0E16] px-4 py-5">
        <Link to="/" className="flex items-center gap-2 px-1">
          <span className="font-mono text-[15px] font-medium tracking-wide text-accent">
            law<span className="text-slate-600">-</span>os
          </span>
        ...
        <div className="mt-3 flex items-center gap-2 px-1 font-mono text-[11px] text-slate-500">
          ...
          Brain loaded <span className="text-slate-400">~/hartwell-brain</span>
        </div>
        ...
        <div className="mt-auto space-y-3">
          {current.id === "phase-1" && (
            <div className="glass p-3 text-xs leading-relaxed text-slate-400">
              <span className="font-semibold text-white">Free plan.</span> Lawyer
              Onboarding (context + skills + workflows + automation) is free. Matter
